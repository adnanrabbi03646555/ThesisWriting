...
\begin{figure}[htbp]
	\centering
	\makebox[\textwidth]{\includegraphics[width=130mm,scale=.50]{styles/bugDetectionDiagram.pdf}}
	\label{bugDetection}
