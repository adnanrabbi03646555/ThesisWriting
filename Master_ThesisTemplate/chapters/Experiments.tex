...
%	\includegraphics{styles/authentication_scenario.png}
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{styles/authentication.pdf}}
...
%	\includegraphics{styles/declassification_scenario.png}
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{styles/declassification.pdf}}
...
\begin{figure}[htbp]
	...
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{styles/sanitization.pdf}}
...
\begin{figure}[htbp]
	\centering
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{styles/bug_detection.pdf}}
	\label{bugDetection}
...
\begin{figure}[htbp]
	\centering
	\makebox[\textwidth]{\includegraphics[width=\textwidth]{styles/bugDetectionWithMessage.pdf}}
