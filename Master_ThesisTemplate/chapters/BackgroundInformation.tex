...
\section{Declassify Confidential Information}
...
Myers et al. \cite{ref_4_myers2000protecting} introduced the decentralized label model, describing how labels could be applied
...
\begin{itemize}
   ...
   model \cite{ref_24_myers:descentrelized} security labels with explicit ownership information. According to this approach, information release of some data is safe if it is performed by the
...
\section{Authenticate User Access}
